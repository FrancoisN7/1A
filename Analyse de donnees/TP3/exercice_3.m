...
code_classe =  1*(V_chrysanthemes>=V_oeillets & V_chrysanthemes>=V_pensees)...
             + 2*(V_oeillets>V_chrysanthemes & V_oeillets>=V_pensees)...
             + 3*(V_pensees>V_chrysanthemes & V_pensees>V_oeillets)...
             + 4*(V_pensees==(V_chrysanthemes==(V_oeillets==0)));  
...
carte_couleurs = [.45 .45 .65 ; .45 .65 .45 ; .65 .45 .45 ; .45 .45 .10];
