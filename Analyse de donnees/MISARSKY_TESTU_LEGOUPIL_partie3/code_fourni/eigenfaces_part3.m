...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Données
A = Sigma2;         % matrice dont on cherche des couples propres
m = 16;         % taille maximale de l'espace invariant que l'on va utiliser
percentage = 0.35; % pourcentage recherché de la trace 
eps = 1e-4;   % seuil pour déterminer si un vecteur de l'espace invariant a convergé
maxit = 10000;     % nombre maximum d'itérations de la méthode
p=10;
