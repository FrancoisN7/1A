...
begin
    ...
    -- Afficher_Deux_Positions (2); -- Afficher_Deux_Positions n'est pas dans le .ads
    New_Line;
    ...
    -- Une_Date.jour := 15; -- T_date est en privé
    -- Une_Date.Mois := Mois_Suivant; T_date est en privé
    Afficher (Une_Date);
    New_Line;

    -- Illustrer les opérations possibles sur T_Date, type privé
    -- Autre_Date := Une_Date; --Pas le droit au "="
    Put ("Autre date : ");
    Afficher (Autre_Date);
    New_Line;

    -- if Autre_Date = Une_Date then --Pas le droit au "="
