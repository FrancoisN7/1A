...
public class EditeurLigne {
	...
	public EditeurLigne(Ligne l) {
		...
		menuPrincipal.ajouter("Reculer le curseur au début de la ligne",
					new CommandeRetour(ligne));
		menuPrincipal.ajouter("Supprimer l'élément sous le curseur",
					new CommandeSupprimerEle(ligne));
		CommandeSousMenu sousMenuDep = new CommandeSousMenu(ligne,"SousMenuDep");
		menuPrincipal.ajouter("Créer un sous menu déplacement",sousMenuDep);

		sousMenuDep.ajoutersousmenu("Avancer le curseur d'un caractère",
				new CommandeCurseurAvancer(ligne));
		sousMenuDep.ajoutersousmenu("Reculer le curseur d'un caractère",
				new CommandeCurseurReculer(ligne));
